...
class Table {
    ...
    static focus(element) {
        var _a;
        const focusElementList = getFocusElementList(element, tabbableSelectorIgnoreTabIndex);
        if ((((_a = element.firstElementChild) === null || _a === void 0 ? void 0 : _a.classList.contains("cds--table-sort")) && focusElementList.length > 1) ||
...
class TableContainer {
    ...
    ngAfterContentInit() {
        ...
        if (this.table) {
            this.table.ariaLabelledby = (_a = this.headerTitle) === null || _a === void 0 ? void 0 : _a.id;
            this.table.ariaDescribedby = (_b = this.headerDescription) === null || _b === void 0 ? void 0 : _b.id;
        }
    }
}
