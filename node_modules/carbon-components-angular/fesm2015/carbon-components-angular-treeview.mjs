...
class TreeNodeComponent {
    ...
    set node(node) {
        ...
        this.value = (_f = node.value) !== null && _f !== void 0 ? _f : this.value;
        this.icon = (_g = node.icon) !== null && _g !== void 0 ? _g : this.icon;
        this.selected = (_h = node.selected) !== null && _h !== void 0 ? _h : this.selected;
        this.depth = (_j = node.depth) !== null && _j !== void 0 ? _j : this.depth;
        this.children = (_k = node.children) !== null && _k !== void 0 ? _k : this.children;
    }
    get node() {
        return this._node;
    }
