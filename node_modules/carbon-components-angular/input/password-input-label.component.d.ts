...
export declare class PasswordInputLabelComponent extends BaseIconButton implements AfterViewInit {
    ...
    */
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PasswordInputLabelComponent, "cds-password-label, ibm-password-label", never, { "labelInputID": "labelInputID"; "disabled": "disabled"; "skeleton": "skeleton"; "labelTemplate": "labelTemplate"; "passwordInputTemplate": "passwordInputTemplate"; "helperText": "helperText"; "invalidText": "invalidText"; "invalid": "invalid"; "warn": "warn"; "warnText": "warnText"; "ariaLabel": "ariaLabel"; "hidePasswordLabel": "hidePasswordLabel"; "showPasswordLabel": "showPasswordLabel"; }, {}, ["textInput"], ["*", "[cdsPassword], [ibmPassword]"], false>;
}
